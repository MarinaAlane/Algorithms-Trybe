def is_anagram(first_string, second_string):
    ...
    sorted_first_string = merge_sort(first_string_list)
    sorted_second_string = merge_sort(second_string_list)

    if (sorted_first_string == sorted_second_string):
        return True
    return False

# funções merge_sort e merge adaptadas do conteúdo do course
