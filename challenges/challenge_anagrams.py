...
# essa implementação funciona para comparação de caracteres pois a linguagem compara os valores da tabela ascii
# um potencial bug para a aplicação da forma que está implementada é não lidar com a capitalização de palavras
# como há limite de tempo um bypass para manter a capitalização das letras não foi implementado para preservar a performance.
